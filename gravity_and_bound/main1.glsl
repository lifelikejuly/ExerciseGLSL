...
{ 
    ...
    for (int x = 0; x < NB_PARTICLES; x++)
    {
        for (int y = 0; y < NB_PARTICLES; y++)
        {
            ...
            {
                float val = (currentParticle.z * currentParticle.z + currentParticle.w * currentParticle.w) *0.01;
